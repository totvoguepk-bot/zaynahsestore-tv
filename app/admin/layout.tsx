            ...
            <div key={section.key} className="mb-3">
              {section.label && (
                <button
                  ...
                  className={`flex items-center justify-between w-full px-4 py-2 text-[10px] font-black uppercase tracking-widest cursor-pointer transition-opacity ${section.key === 'settings' ? 'text-current border-l-2 border-[#e94560] pl-3 opacity-90' : 'text-current opacity-60 hover:opacity-90'}`}
                >
          ...
          {navSections.map(section => (
            <div key={section.key} className="mb-3">
              {section.label && (
                <button
                  onClick={() => toggleSection(section.key)}
                  className={`flex items-center justify-between w-full px-4 py-1.5 text-[10px] font-black uppercase tracking-widest cursor-pointer transition-opacity ${section.key === 'settings' ? 'text-current border-l-2 border-[#e94560] pl-3 opacity-90' : 'text-current opacity-60 hover:opacity-90'}`}
                >
                  <div className="flex items-center gap-2">
                    <span>{section.label}</span>
