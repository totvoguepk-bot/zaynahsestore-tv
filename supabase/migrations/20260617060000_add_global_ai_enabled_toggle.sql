-- Add global ai_enabled toggle to both tables
ALTER TABLE store_settings ADD COLUMN IF NOT EXISTS ai_enabled BOOLEAN DEFAULT false;
ALTER TABLE ai_settings ADD COLUMN IF NOT EXISTS ai_enabled BOOLEAN DEFAULT false;

-- Recreate trigger store_settings -> ai_settings to include ai_enabled
...
-- Recreate trigger ai_settings -> store_settings to include ai_enabled
